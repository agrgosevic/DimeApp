...
namespace Dime.Forme.Statistika
{
    public partial class FrmStatistikaOdabraneUtakmice : Form
    {
        ...
        private void Pomoc()
        {
            ...
            {
                HelpFrmStatOdabraneUtakmice helpForma = new HelpFrmStatOdabraneUtakmice();
        ...
        private void FrmStatistikaOdabraneUtakmice_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            Pomoc();
        }
    }
